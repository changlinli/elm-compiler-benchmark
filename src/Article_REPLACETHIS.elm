module Article_REPLACETHIS exposing (Article, Full, Preview, author, body, favorite, favoriteButton, fetch, fromPreview, fullDecoder, mapAuthor, metadata, previewDecoder, slug, unfavorite, unfavoriteButton)
...
import Article_REPLACETHIS.Body as Body exposing (Body)
import Article_REPLACETHIS.Slug as Slug exposing (Slug)
import Article_REPLACETHIS.Tag as Tag exposing (Tag)
import Author_REPLACETHIS as Author exposing (Author)
