module Page_REPLACETHIS.Article exposing (Model, Msg, init, subscriptions, toSession, update, view)
...
import Article_REPLACETHIS as Article exposing (Article, Full, Preview)
import Article_REPLACETHIS.Body exposing (Body)
import Article_REPLACETHIS.Comment as Comment exposing (Comment)
import Article_REPLACETHIS.Slug as Slug exposing (Slug)
import Author_REPLACETHIS as Author exposing (Author(..), FollowedAuthor, UnfollowedAuthor)
import Avatar_REPLACETHIS as Avatar
import Browser.Navigation as Nav
import CommentId_REPLACETHIS as CommentId exposing (CommentId)
import Html exposing (..)
import Html.Attributes exposing (attribute, class, disabled, href, id, placeholder, value)
import Html.Events exposing (onClick, onInput, onSubmit)
import Http
import Json.Decode as Decode
import Loading_REPLACETHIS as Loading
import Log_REPLACETHIS as Log
import Page_REPLACETHIS as Page
import Profile_REPLACETHIS as Profile exposing (Profile)
import Route_REPLACETHIS as Route
import Session_REPLACETHIS as Session exposing (Session)
import Task exposing (Task)
import Time
import Timestamp_REPLACETHIS as Timestamp
import Username_REPLACETHIS as Username exposing (Username)
import Viewer_REPLACETHIS as Viewer exposing (Viewer)
                ...
                div [ class "article-page" ]
                    ...
                    , div [ class "container page" ]
                        [ div [ class "row article-content" ]
                            [ div [ class "col-md-12" ]
                                [ Article_REPLACETHIS.Body.toHtml (Article.body article) [] ]
                            ]
                        , hr [] []
