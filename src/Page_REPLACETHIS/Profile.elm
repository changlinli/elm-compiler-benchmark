module Page_REPLACETHIS.Profile exposing (Model, Msg, init, subscriptions, toSession, update, view)
...
import Article_REPLACETHIS as Article exposing (Article, Preview)
import Article_REPLACETHIS.Feed as Feed
...
import PaginatedList_REPLACETHIS as PaginatedList exposing (PaginatedList)
